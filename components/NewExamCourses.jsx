...
//     <div
//       id="course"
//       className="relative px-4 sm:px-6 py-10 bg-[#FFEFE0] rounded-2xl mx-auto w-[95%] max-w-[1600px] min-h-[500px] sm:min-h-[600px] lg:min-h-[700px] border border-gray-300 overflow-hidden"
//     >
//       {/* 🧠 Title */}
//       <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center mb-6 text-quicksand">
//         Focused Exam Mastery Courses
...
//       {/* 🧭 Year Navigation Bar (scrollable) */}
//       <div
//         ref={yearBarRef}
//         className="flex sm:justify-center justify-start gap-3 sm:gap-4 mb-8 sm:mb-10 p-3 sm:p-4 bg-orange-100 rounded-xl overflow-x-auto scrollbar-hide scroll-smooth"
//       >
//         {years.map((year) => (
//           <button
//             key={year}
...
//               ${activeYear === year ? "text-orange-600" : ""}`}
//           >
//             {year}
//             {activeYear === year && (
//               <motion.div
...
//           transition={{ duration: 0.4, ease: "easeInOut" }}
//           ref={containerRef}
//           className={`flex gap-4 sm:gap-6 overflow-x-auto sm:overflow-visible px-2 sm:px-0 scroll-snap-x scroll-snap-mandatory`}
//         >
//           {items.map((course) => (
//             <motion.div
//               key={course.id}
...
//               transition={{ type: "spring", stiffness: 200, damping: 15 }}
//               className={`snap-start bg-white rounded-2xl shadow-md hover:shadow-2xl overflow-hidden flex flex-col 
//                 w-[85vw] sm:w-[360px] md:w-[400px] lg:w-[420px] xl:w-[460px] flex-shrink-0`}
//             >
//               {/* 📸 Image */}
//               <div className="m-3 sm:m-4 rounded-xl border border-gray-200 overflow-hidden">
//                 <div className="relative w-full aspect-[6000/3375] bg-gray-200">
    ...
    >
      ...
      <AnimatePresence mode="wait">
        <motion.div
          ...
          transition={{ duration: 0.4, ease: "easeInOut" }}
          ref={containerRef}
          className="flex justify-center flex-wrap gap-6 px-2 sm:px-0"
        >
          {items.map((course) => (
            <motion.div
              key={course.id}

...
export default function E11Choose() {
  const features = [
    {
      image: "/eleven/choose/1.png",
      title: "Personalized 1:1 Learning",
      desc: "300+ Total Tutors",
    },
    {
      image: "/eleven/choose/2.png",
      title: "AI-Powered Adaptive Practice Papers",
      desc: "2000+ Total Worksheets",
    },
    {
      image: "/eleven/choose/3.png",
      title: "Real-Time Progress Analytics",
      desc: "70 Total Courses",
    },
    {
      image: "/eleven/choose/4.png",
      title: "Expert Tutors Who Specialize in 11+ Prep",
      desc: "AI Tutor",
    },
  ];
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {features.map((f, i) => (
            ...
            >
              ...
              {/* Bottom Image */}
              <div className="mt-5 flex items-center">
                <div className="bg-[#EAF0FF] w-10 h-10 flex items-center justify-center rounded-full p-2">
                  <Image
                    src={f.image}
                    alt={`Feature ${i + 1}`}
                    width={24}

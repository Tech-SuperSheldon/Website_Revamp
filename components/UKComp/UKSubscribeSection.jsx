...
//           />
//           <div className="absolute top-1/2 right-2 -translate-y-1/2">
//             <UKGlossyButton type="submit" className="px-4 py-2 rounded-full text-sm">
//              Book Free Trial Now
//             </UKGlossyButton>
//           </div>
//           {error && <p className="absolute left-4 -bottom-6 text-red-400 text-sm">{error}</p>}
...
// export default UKSubscribeSection;
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-xl px-4">
        ...
        <p className="mb-6 text-sm sm:text-base md:text-lg">
          Book a free diagnostic test and see how your child can excel with
          Super Sheldon.
        </p>

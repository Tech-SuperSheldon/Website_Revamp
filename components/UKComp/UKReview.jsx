...
//       <div className="mt-12 w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6">
//         {/* Card 1 */}
//         <div className="relative bg-[#F0FCFF] rounded-3xl border border-[#E1F6FA] shadow-sm hover:shadow-md transition-all duration-300 text-left p-8">
//           <div className="flex items-center mb-4">
//             <div className="bg-[#00C4E0] w-14 h-14 flex items-center justify-center rounded-full">
//               <GraduationCap className="text-white w-7 h-7" />
//             </div>
//             <h3 className="ml-4 font-poppins font-semibold text-lg sm:text-xl text-gray-900">
//               Expert Tutors
//             </h3>
//           </div>
//           <p className="text-gray-700 font-poppins text-sm sm:text-base leading-relaxed">
//             Expert Tutors Providing Personalised Guidance For Every Student.
//           </p>
...
//         {/* Card 2 */}
//         <div className="relative bg-[#F3F1FF] rounded-3xl border border-[#E6E1FF] shadow-grey shadow-sm hover:shadow-md transition-all duration-300 text-left p-8">
//           <div className="flex items-center mb-4">
//             <div className="bg-[#5A49E3] w-14 h-14 flex items-center justify-center rounded-full">
...
//           </div>
//           <p className="text-gray-700 font-poppins text-sm sm:text-base leading-relaxed">
//             Effective Exam Practice To Boost Confidence And Results.
//           </p>
//           <div className="absolute top-3 right-3 opacity-20">
//             <span className="text-gray-400 text-2xl">✨</span>
//           </div>
...
//         {/* Card 3 */}
//         <div className="relative bg-[#FFF8E6] rounded-3xl border border-[#FFF2CC] shadow-md hover:shadow-lg shadow-grey transition-all duration-300 text-left p-8">
//           <div className="flex items-center mb-4">
//             <div className="bg-[#FDBE34] w-14 h-14 flex items-center justify-center rounded-full">
...
//           </div>
//           <p className="text-gray-700 font-poppins text-sm sm:text-base leading-relaxed">
//             Awarded For Outstanding Performance And Top Results.
//           </p>
//           <div className="absolute top-3 right-3 opacity-20">
//             <span className="text-gray-400 text-2xl">✨</span>
//           </div>
  ...
  return (
    <section className="relative py-12 flex flex-col items-center text-center px-4 sm:px-6 lg:px-12">
      ...
      <div className="mt-12 w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Card 1 */}
        <div
          className="relative rounded-3xl border p-8 text-left transition-all duration-500 hover:-translate-y-2 hover:shadow-xl"
          style={{
            backgroundColor: "#F0FCFF",
            borderColor: "#E1F6FA",
            boxShadow: "0 8px 20px rgba(240, 252, 255, 0.6)",
          }}
        >
          <div className="flex items-center mb-4">
            <div className="bg-[#00C4E0] w-14 h-14 flex items-center justify-center rounded-full">
        ...
        <div
          ...
          style={{
            ...
            borderColor: "#E6E1FF",
            boxShadow: "0 8px 20px rgba(243, 241, 255, 0.6)",
          }}
        >
          <div className="flex items-center mb-4">
            <div className="bg-[#5A49E3] w-14 h-14 flex items-center justify-center rounded-full">
        ...
        <div
          ...
          style={{
            ...
            borderColor: "#FFF2CC",
            boxShadow: "0 8px 20px rgba(255, 248, 230, 0.6)",
          }}
        >
          <div className="flex items-center mb-4">
            <div className="bg-[#FDBE34] w-14 h-14 flex items-center justify-center rounded-full">

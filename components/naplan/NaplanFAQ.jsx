...
const faqSections = [
  {
    ...
    faqs: [
      {
        question: "How is this different from other NAPLAN prep courses?",
        answer:
          "SuperSheldon combines expert tutors with AI-driven practice to create personalized learning paths for every student.",
      },
      {
        question: "Is this suitable for Year 3/5/7/9 students?",
        answer:
          "Yes! Our adaptive program is tailored to match each year level’s NAPLAN syllabus and skill requirements.",
      },
      {
        question: "How are sessions scheduled?",
        answer:
          "Sessions are flexible and scheduled based on your availability through our easy online booking system.",
      },
      {
        question: "Can parents track progress?",
        answer:
          "Absolutely. Parents receive weekly performance reports and real-time dashboards to monitor improvement.",
      },
    ],
  },
  {
  ...
  {faqSections.map((section, idx) => (
    ...
    >
      ...
      <div className="absolute top-40 sm:top-64 right-4 sm:right-12 animate-float1 z-10">
        <img src="/icons/alarm.png" alt="" className="w-10 sm:w-[60px]" />
      </div>

...
const academy = getAcademy("au", "school-readiness");
const theme = academyTheme("au");

export const metadata = {
  title: academy.metaTitle,
  description: academy.metaDescription,
  alternates: { canonical: "/au/academies/school-readiness" },
};

export default function AUSchoolReadinessPage() {
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <AcademyCourses academySlug="school-readiness" />
      <NSProcess

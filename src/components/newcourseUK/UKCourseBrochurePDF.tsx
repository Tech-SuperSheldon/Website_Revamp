...
const S = StyleSheet.create({
  ...
  topStripe: { height: 4, backgroundColor: C.blue },
  ...
  statValue: {
    fontSize: 15, fontFamily: "Helvetica-Bold", color: C.blue, marginBottom: 2,
  },
  ...
  sectionAccent: {
    width: 30, height: 3, backgroundColor: C.blue,
  ...
  relevancyLabel: {
    ...
    color: C.blue, letterSpacing: 0.5, marginBottom: 1,
  },
  relevancyText: { fontSize: 7.5, lineHeight: 1.3, color: C.blueDk },
  ...
  priceCardRec: {
    ...
    borderColor: C.blue, borderRadius: 10, padding: 12,
    backgroundColor: C.cream,
  },
  priceBadge: {
    alignSelf: "flex-start", fontSize: 6.5, fontFamily: "Helvetica-Bold",
    color: C.blueDk, backgroundColor: C.creamBdr,
  ...
  priceAmount: { fontSize: 20, fontFamily: "Helvetica-Bold", color: C.blue, marginBottom: 1 },
  ...
  benefitDot: {
    ...
    backgroundColor: C.blue, marginTop: 4, marginRight: 7,
  },
  ...
  ctaHL: { color: C.blue, fontFamily: "Helvetica-Bold" },
...
/* ─── Component ──────────────────────────────────────── */
export default function UKCourseBrochurePDF({ course }: { course: Course }) {
        ...
        <View style={[S.body, { paddingTop: 22 }]}>
          ...
          {course.pricing && course.pricing.length > 0 ? (
            ...
            <View style={S.fallbackBox}>
              ...
              <Text style={{ fontSize: 9.5, color: C.blueDk, fontFamily: "Helvetica-Bold" }}>

...
export default function UKNewExamCourses() {
  ...
  return (
    ...
    >
      ...
      <div
        ref={yearBarRef}
        className="flex justify-start sm:justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 p-3 sm:p-4 bg-orange-100 rounded-xl overflow-x-auto scrollbar-hide scroll-smooth"
      >
        {years.map((year) => (
          <button
            key={year}

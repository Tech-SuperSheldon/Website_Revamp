...
const UKExamBanner = () => {
  return (
    <div className="flex justify-center p-4">
      <div className="relative w-full max-w-6xl h-auto min-h-[220px] rounded-2xl overflow-hidden md:overflow-visible px-0 md:px-10 lg:px-12 py-8 flex flex-col md:flex-row items-center justify-between bg-indigo-900 shadow-xl dark:bg-indigo-950">
        
        {/* Text Section */}
        <div className="flex flex-col z-10 space-y-4 text-center md:text-left px-6 md:px-0">
          <div className="text-white text-3xl md:text-4xl lg:text-5xl font-extrabold leading-tight">
            Expert-Curated
            <span className="ml-3 inline-block bg-yellow-400 text-indigo-900 px-3 py-1 rounded-lg text-2xl md:text-3xl lg:text-4xl font-bold shadow-md">
              UK Exam
          ...
          {/* Stats */}
          <div className="flex justify-center md:justify-start space-x-10 mt-3 text-white">
            <div>
              <div className="text-3xl font-extrabold">2.5K+</div>
              <div className="text-xs md:text-sm opacity-80 mt-1">UK Active Students</div>
            </div>
        ...
        {/* Image Section */}
        <div className="translate-y-8 md:translate-y-0 relative w-full md:w-auto mt-6 md:mt-0 md:absolute md:right-0 md:bottom-0 z-0 flex justify-center md:justify-end items-end">
          <img
            src="/UK/banner1.png"
            alt="UK Exam Students and Instructors"
            className="w-full md:w-auto h-[220px] sm:h-[260px] md:h-[300px] lg:h-[340px] object-cover md:object-contain drop-shadow-2xl md:rounded-none"
          />
        </div>

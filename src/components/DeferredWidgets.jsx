...
const LazyNovaChatbot = dynamic(() => import("@/components/NovaChatbot"), {
  ssr: false,
  loading: () => null,
});

const LazyFloatingArrowWhatsApp = dynamic(() => import("@/components/ArrowAndWhatsapp"), {
  ssr: false,
  loading: () => null,
});

const LazyNSCookieConsent = dynamic(() => import("@/components/NSCookieConsent"), {
  ssr: false,
  loading: () => null,
});

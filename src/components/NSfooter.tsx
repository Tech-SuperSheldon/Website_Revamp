        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-8 lg:gap-6 xl:gap-10 mb-8 sm:mb-10 text-white items-start">
            ...
            >
              ...
              <ul className="space-y-2 font-medium text-white text-[13px] sm:text-[14px]">
                <li><RollingLink href="/academies/school-readiness" hoverColor="text-black" baseColor="text-white">School Readiness</RollingLink></li>
                <li><RollingLink href="/academies/exam-readiness" hoverColor="text-black" baseColor="text-white">Exam Academy</RollingLink></li>
                <li><RollingLink href="/academies/skill" hoverColor="text-black" baseColor="text-white">Skill Academy</RollingLink></li>
              </ul>
            </motion.div>

  ...
  return (
    <div className="bg-white pt-6 sm:pt-20">
      <motion.footer 
        ...
        className="relative w-full bg-[#E87F1E] rounded-t-[2.5rem] md:rounded-t-[4rem] flex flex-col pt-10 pb-6 md:pt-20 md:pb-10 overflow-hidden shadow-2xl"
      >
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8 mb-20 text-white">
              
              {/* Brand Section: Fixed width to keep it consistent with left margin */}
              <motion.div 
                  initial={{ opacity: 0, x: -20 }}
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6 }}
                  className="lg:w-[25%] lg:ml-16 flex flex-col items-start"
              >
                  ...
                  <p className="text-white font-medium text-[17px] leading-relaxed mb-8">
                  ...
                  {/* Contact Info */}
                  <div className="flex flex-col gap-3 mb-6 text-[15px] text-white font-medium">
                  ...
                  <div className="flex flex-wrap gap-3">
                      ...
                      <SocialIcon href="https://x.com/SuperSheldonHQ" label="X" color="hover:text-black" icon={
                          <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                      } />
                      {/* WhatsApp */}
              ...
              {/* Links Section: Compacted and pushed right with margin */}
              {/* w-auto allows it to shrink. justify-between spreads them. gap-x-10 makes columns wider. lg:mr-16 adds right spacing. */}
              <motion.div 
                  initial={{ opacity: 0, y: 30 }}
                  whileInView={{ opacity: 1, y: 0 }}
                  viewport={{ once: true }}
                  transition={{ duration: 0.6, delay: 0.2 }}
                  className="lg:w-auto lg:mr-16 grid grid-cols-2 md:grid-cols-4 gap-x-10 gap-y-10"
              >
                  
                  {/* Column 1: Sitemap */}
                  <div>
                       <h4 className="font-bold text-xl text-white mb-6 font-rowdies">Sitemap</h4>
                  ...
                  {/* Column 2: Learn */}
                  <div>
                       <h4 className="font-bold text-xl text-white mb-6 font-rowdies">Learn</h4>
                       <ul className="space-y-4 font-medium text-white">
                  ...
                  {/* Column 3: Account */}
                  <div>
                       <h4 className="font-bold text-xl text-white mb-6 font-rowdies">Account</h4>
                       <ul className="space-y-4 font-medium text-white">
                          ...
                          {/* <li><RollingLink href="https://supersheldon.wise.live/" target="_blank" rel="noopener noreferrer" hoverColor="text-black" baseColor="text-white">Reset Password</RollingLink></li> */}
                  ...
                  <div>
                       <h4 className="font-bold text-xl text-white mb-6 font-rowdies">Information</h4>
                       <ul className="space-y-4 font-medium text-white">
          ...
          <motion.div
            ...
            className="border-t border-white/25 pt-8 flex flex-col md:flex-row items-center justify-between gap-4"
          >

  ...
  return (
    <div className="bg-white pt-2 sm:pt-4">
      <motion.footer
        ...
        className="relative w-full bg-[#2563EB] rounded-t-[2.5rem] md:rounded-t-[4rem] flex flex-col pt-8 pb-4 md:pt-10 md:pb-6 overflow-hidden shadow-2xl"
      >
          ...
          <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-6 mb-6 text-white">
              ...
              >
                  ...
                  <p className="text-white font-medium text-[15px] leading-relaxed mb-4">
                      SuperSheldon is a trusted online learning platform offering expert-led exam preparation for UK students.
                  </p>

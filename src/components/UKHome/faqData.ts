export const faqSections = [
  {
    ...
    subtitle: "Understand what your child will learn and how our classes work.",
    faqs: [
      {
        question: "What age groups are SuperSheldon courses designed for?",
        answer:
          "Our programs are tailored for students from Year 3 to Year 12, covering early foundation levels to advanced exam preparation for NAPLAN, ICAS, Selective School, and HSC across the UK.",
      },
      {
  ...
  },
  {
    ...
    subtitle: "Privacy, recordings, and scheduling — all answered here.",
    faqs: [
      {
  ...
  },
  {
    ...
    subtitle: "Learn how our expert teachers support your child's journey.",
    faqs: [
      {
      ...
      {
        question:
          "Does my child need prior experience or preparation before joining?",
        answer:

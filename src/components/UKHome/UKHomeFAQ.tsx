...
export default function UKHomeFAQ() {
      ...
      */}
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center gap-3 px-4 mb-2">
            ...
            <Link href="/demo" className="flex-1 sm:flex-none text-center bg-blue-100 hover:bg-blue-200 text-blue-800 font-semibold py-2.5 px-4 sm:px-8 rounded-full transition-colors duration-300 shadow-sm border border-blue-200 transform hover:scale-105 text-sm sm:text-base whitespace-nowrap">
                Try a Free Class
            </Link>
        </div>

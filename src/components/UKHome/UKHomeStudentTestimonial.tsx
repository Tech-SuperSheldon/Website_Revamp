...
const testimonials = [
  {
    text: " My name's Alex. I'm from London. I joined Super Sheldon around two months, and really happy with the teacher, kind and pensive, and explain me maths and English. I understand, and I am really happy now. Thank you.",
    name: "— Alex, Year 4, UK Student", // Trimmed trailing space
    image: "/k4b.webp",
  },
  {
    text:
            ...
            {/* Stats Content - Horizontal/Grid for sleekness */}
             <div className="relative inset-0 flex flex-col justify-center z-10 h-full">
                <div className="grid grid-cols-3 lg:grid-cols-1 gap-2 md:gap-6 lg:gap-8 text-center lg:text-left">
                     <div>
                        <h3 className="text-3xl md:text-5xl lg:text-7xl font-rowdies font-black tracking-tighter text-[#1d4ed8]">

...
const slides = [
  ...
  },
  {
    ...
    heading: "Trusted by Families Across the UK",
    desc: "SuperSheldon is a trusted platform, used and loved by families across the UK.",
    color: "#8b5cf6", // Violet-500
  },
];

export default function UKHomeChoose() {

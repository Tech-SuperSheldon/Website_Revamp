...
export default function UKHomeTeacherTest() {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl md:text-5xl font-bold text-gray-900 mb-3 md:mb-4 leading-tight">
            ...
            — Unlock <span className="text-[#1d4ed8]">Your Potential</span>
          </h2>
          ...
          <div className="flex items-center justify-center gap-3 md:gap-4">
            <Link href="/demo">
              <button className="px-6 md:px-8 py-2 md:py-3 bg-[#1d4ed8] text-white rounded-full font-semibold shadow-lg hover:shadow-blue-500/30 hover:bg-[#1e40af] transition-all transform hover:-translate-y-1 text-sm md:text-base">
                Try a free class
              </button>
            </Link>
            <Link href="/new-courses">
                <button className="px-6 md:px-8 py-2 md:py-3 bg-blue-50 text-[#1d4ed8] border-2 border-blue-100 rounded-full font-semibold hover:bg-blue-100 transition-colors text-sm md:text-base">
                Explore Subjects
                </button>
            </Link>
          </div>
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-[280px] md:max-w-[320px] aspect-[9/16] bg-gray-900 rounded-[32px] overflow-hidden shadow-2xl border-8 border-white ring-4 ring-blue-100 transform transition-transform hover:scale-105 duration-500 mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-2">
                <span className="text-[8px] font-bold text-blue-600 bg-blue-100 px-2 py-0.5 rounded">Year 5</span>
                <span className="ml-auto text-[8px] bg-blue-50 text-[#1d4ed8] px-1.5 py-0.5 rounded border border-blue-100">Math</span>
            </div>
            <h4 className="text-xs font-bold text-gray-900 leading-tight mb-2">
                Mastering Fractions &amp; Decimals
            </h4>
            <Link href="/demo">
              <button className="w-full py-1.5 bg-[#1d4ed8] text-white text-xs font-semibold rounded-lg hover:bg-[#1e40af] transition-colors shadow-sm">
                  Try a free class
              </button>
            </Link>
          </motion.div>
          ...
          >
             <div className="flex items-center gap-2 mb-2">
                <span className="text-[8px] font-bold text-blue-600 bg-blue-100 px-2 py-0.5 rounded">Year 9</span>
                <span className="ml-auto text-[8px] bg-blue-50 text-[#1d4ed8] px-1.5 py-0.5 rounded border border-blue-100">Chem</span>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-2">
                <span className="text-[8px] font-bold text-blue-600 bg-blue-100 px-2 py-0.5 rounded">Year 10</span>
                <span className="ml-auto text-[8px] bg-blue-50 text-[#1d4ed8] px-1.5 py-0.5 rounded border border-blue-100">Physics</span>
            </div>
            <h4 className="text-xs font-bold text-gray-900 leading-tight mb-2">
          ...
          >
            <div className="flex items-center gap-2 mb-2">
                <span className="text-[8px] font-bold text-blue-600 bg-blue-100 px-2 py-0.5 rounded">Year 4</span>
                <span className="ml-auto text-[8px] bg-blue-50 text-[#1d4ed8] px-1.5 py-0.5 rounded border border-blue-100">English</span>
            </div>
            <div className="relative w-full h-20 rounded-xl overflow-hidden mb-2 bg-gray-50">

...
const navLinks = [
  ...
  { name: "Become a Teacher", href: "/au/become-a-teacher" },
];
      ...
      */}
      ...
      >
        ...
        >
          ...
          >
          {/* Logo */}
          <Link href="/au" className="flex items-center gap-2 w-16 sm:w-20 md:w-24 shrink-0">
            <motion.div
        ...
        {isMobileMenuOpen && (
          ...
          >
            ...
            >
             ...
             <Link href="/au/demo" data-floating-cta-avoid="menu" onClick={() => setIsMobileMenuOpen(false)} className="w-full max-w-[280px]">

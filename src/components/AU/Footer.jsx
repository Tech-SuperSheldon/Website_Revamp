        ...
        <div className="lg:w-3/5 grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-800 text-sm sm:text-base">
              <li><Link href="/au/privacy" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">Privacy Policy</Link></li>
              {/* <li><Link href="/au/refund" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">Refund Policy</Link></li> */}
              <li><Link href="/au/terms" target="_blank" rel="noopener noreferrer" className="hover:text-gray-900">Terms & Conditions</Link></li>
            </ul>
          </div>

          <div>
            <Link href="/au/courses">
              <h3 className="font-extrabold text-orange-600 mb-2 text-lg sm:text-xl uppercase tracking-wide">Courses</h3>
            </Link>
            <ul className="space-y-2 text-gray-800 text-sm sm:text-base">
              <li><Link href="/au/courses" className="hover:text-gray-900">Naplan Exam</Link></li>
              <li><Link href="/au/courses" className="hover:text-gray-900">ICAS</Link></li>
              <li><Link href="/au/courses" className="hover:text-gray-900">HCS</Link></li>
            </ul>
          </div>

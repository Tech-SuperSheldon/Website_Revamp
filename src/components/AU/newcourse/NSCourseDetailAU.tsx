    ...
    <div className="min-h-screen pb-20 pt-24 md:pt-40 font-sans bg-white">
      ...
      <div className="container mx-auto px-4 max-w-7xl mb-12">
           <div className="flex items-center gap-2 text-sm text-gray-500 mb-6">
                <Link href="/au" className="hover:text-orange-600 transition-colors">Home</Link>
                <span>/</span>
                <Link href="/au/new-courses" className="hover:text-orange-600 transition-colors">Courses</Link>
                <span>/</span>

...
export default function Home2Hero() {
  ...
  return (
    <section
      ...
      // iframe, a separate document the floating button's IntersectionObserver
      // can't see into directly. Marking the whole hero as an avoid-target is
      // the practical fix: it's nearly full-viewport height, so while any of it
      // is on screen there's already a "Try a Free Class" CTA in view within it.

  ...
  return (
    <div className="bg-white pt-2 sm:pt-4">
      <motion.footer 
        ...
        className="relative w-full bg-[#03215F] rounded-t-[1.5rem] sm:rounded-t-[2.5rem] md:rounded-t-[4rem] flex flex-col pt-6 pb-4 sm:pt-8 md:pt-12 md:pb-6 overflow-hidden shadow-2xl"
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10">
          ...
          {/* Main Content: 5 Columns with balanced spacing */}
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-8 lg:gap-6 xl:gap-10 mb-8 sm:mb-10 text-white items-start">
            ...
            >
              <Link href="/au" className="mb-2 block">
            ...
            >
              <h4 className="font-bold text-base sm:text-lg text-white mb-3 sm:mb-4 font-rowdies">Contact</h4>
            ...
            >
              <h4 className="font-bold text-base sm:text-lg text-white mb-3 sm:mb-4 font-rowdies">Sitemap</h4>
              <ul className="space-y-2 font-medium text-white text-[13px] sm:text-[14px]">
                <li><RollingLink href="/au" hoverColor="text-black" baseColor="text-white">Home</RollingLink></li>
                <li><RollingLink href="/au/new-courses" hoverColor="text-black" baseColor="text-white">Courses</RollingLink></li>
                <li><RollingLink href="/au/new-testimonial" hoverColor="text-black" baseColor="text-white">Reviews</RollingLink></li>
                <li><RollingLink href="/au/new-blogs" hoverColor="text-black" baseColor="text-white">Blogs</RollingLink></li>
                <li><RollingLink href="/au/become-a-teacher" hoverColor="text-black" baseColor="text-white">Become a Teacher</RollingLink></li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2 font-medium text-white text-[13px] sm:text-[14px]">
                <li><RollingLink href="/au/new-courses" hoverColor="text-black" baseColor="text-white">NAPLAN Exam</RollingLink></li>
                <li><RollingLink href="/au/new-courses" hoverColor="text-black" baseColor="text-white">ICAS</RollingLink></li>
                <li><RollingLink href="/au/new-courses" hoverColor="text-black" baseColor="text-white">HSC</RollingLink></li>
                <li><RollingLink href="/au/new-courses" hoverColor="text-black" baseColor="text-white">Selective School</RollingLink></li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-2 font-medium text-white text-[13px] sm:text-[14px]">
                <li><RollingLink href="/au/faq" hoverColor="text-black" baseColor="text-white">FAQ</RollingLink></li>
                <li><RollingLink href="/au/privacy" hoverColor="text-black" baseColor="text-white">Privacy Policy</RollingLink></li>
                <li><RollingLink href="/au/terms" hoverColor="text-black" baseColor="text-white">Terms & Conditions</RollingLink></li>
              </ul>
            </motion.div>
          ...
          <motion.div
            ...
            className="border-t border-white/25 pt-4 pb-2 flex flex-col md:flex-row items-center justify-center text-center"
          >
            <p className="text-white text-[12px] sm:text-[13px] md:text-[14px] font-bold">

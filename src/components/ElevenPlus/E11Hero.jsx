...
import UKGlossyButton from "../UKComp/UKGlossybutton";
...
export default function E11Hero() {
  ...
  const highlightOptions = [
    { text: "11+.", color: "#FFD700" },
    // { text: "GCSE's.", color: "#ff8800ff" },
    // { text: "A-Levels.", color: "#FF1493" },
  ];
  ...
  return (
    <div id="home" className="relative w-fulloverflow-hidden pt-24 md:pt-12 lg:pt-12">
      {/* Content */}

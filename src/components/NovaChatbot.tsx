  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content:
        "Hi! I'm **Nova**, your SuperSheldon assistant 👋\n\nI can help you with:\n• Information about our Australian courses (NAPLAN, ICAS, Selective, Scholarship, Maths, English)\n• Booking a free demo session\n\nWhat would you like to know?",
    },
  ]);
  ...
  const handleBookingFlow = async (userText: string) => {
    ...
    if (bookingStep === "email") {
      ...
      addMessage({
        role: "assistant",
        content:
          "Got it! What's your **phone number**? (include country code, e.g. +61412345678)",
      });
      return;
    }
    ...
    if (bookingStep === "grade") {
      ...
      addMessage({
        role: "assistant",
        content:
          "And which **subject** are you interested in? (e.g. Maths, English, NAPLAN, ICAS, Selective)",
      });
      return;
    }
  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-5 right-4 z-[9999] w-14 h-14 rounded-full bg-gradient-to-br from-orange-500 to-orange-400 shadow-lg shadow-orange-200 flex items-center justify-center text-white"

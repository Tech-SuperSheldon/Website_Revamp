  ...
  return (
    <section className="relative w-full min-h-screen overflow-hidden bg-white text-black pt-32 pb-12 md:pt-36 md:pb-20 lg:pt-40 lg:pb-24">
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        {/* 3-Column Grid: Student Slider | Heading & Form | Phone Mockup */}
        <div className="grid lg:grid-cols-[1.5fr_3fr_1.5fr] gap-8 lg:gap-12 items-center w-full max-w-7xl mx-auto">

          {/* Left: Student Slider */}
          <div className="relative w-full aspect-[517/1066] max-w-[320px] mx-auto">
          ...
          {/* Right: Phone Mockup & Teacher Badge */}
